        ...
        hide: function() {
            ...
            if (!this.isInput) {
                if (this.component) {
                    ...
                    if (this.element.find('input').val() !== '' && this.element.find('input').val() !== 'transparent') {
                        this.element.find('input').prop('value', this.format.call(this)).trigger('change');
                    }
                }
                if (this.element.find('input').val() != "transparent"){
                	this.element.data('color', this.format.call(this));
                }
            } else {
                //if the input value is empty, do not set any color
                if (this.element.val() !== '' && this.element.val() !== "transparent") {
