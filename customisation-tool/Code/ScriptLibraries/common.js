	...
	try {
		...
		if (property != "" && property != null) {
			...
			case "@body-background-color":
				$("#previewframe").contents().find("body").css(
						"background-color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@body-font":
				$("#previewframe").contents().find("body").css("font-family",
						newvalue);
				break;
			case "@navbar-background":
				$("#previewframe").contents().find(".iHeader").css(
						"background", newvalue);
				break;
			...
			case "@navbar-title-text-shadow":
				$("#previewframe").contents().find(".title").css("text-shadow",
						newvalue);
				break;
			case "@navbar-title-color":
				$("#previewframe").contents().find(".title").css("color",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@navbar-title-font-size":
				$("#previewframe").contents().find(".title").css("font-size",
						newvalue);
				break;
			case "@navbar-title-font-weight":
				$("#previewframe").contents().find(".title").css("font-weight",
						newvalue);
				break;
			case "@input-search-frame-input-border":
				$("#previewframe").contents().find(".input-search-frame input")
						.css("border-color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@input-search-frame-input-background":
				$("#previewframe").contents().find(".input-search-frame input")
						.css("background", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@input-search-frame-input-box-shadow":
				$("#previewframe").contents().find(".input-search-frame input")
						.css("box-shadow", newvalue);
				break;
			...
			case "@button-border-radius":
				$("#previewframe").contents().find(
						"#dialogPopup .dialogbuttons .button").css(
						"border-radius", newvalue);
				$("#previewframe").contents().find(".workspace-items a").css(
						"border-radius", newvalue);
				$("#previewframe").contents().find(".input-search-frame input")
						.css("-webkit-border-radius", newvalue);
				$("#previewframe").contents().find(".button").css(
						"border-radius", newvalue);
				$("#previewframe")
						.contents()
						.find(
								".editButton .label, cancelButton .label, .proceedButton .label, .saveButton .label")
						.css("border-radius", newvalue);
				$("#previewframe")
						.contents()
						.find(
								".viewsButton,.homeButton,.searchButton,.syncButton,.newButton,.settingsButton,.backButton")
						.css("border-radius", newvalue);
				break;
			case "@button-box-shadow":
				$("#previewframe").contents().find(
						"#dialogPopup .dialogbuttons .button").css(
						"box-shadow", newvalue);
				$("#previewframe").contents().find(".button").css("box-shadow",
						newvalue);
				$("#previewframe")
						.contents()
						.find(
			...
			case "@button-default-background":
				$("#previewframe").contents().find(
						"#dialogPopup .dialogbuttons .button").css(
						"background", newvalue);
				$("#previewframe").contents().find(".button").css("background",
						newvalue);
				$("#previewframe").contents().find(".editButton .label").css(
						"background", newvalue);
				$("#previewframe")
						.contents()
						.find(
			...
			case "@button-default-label-color":
				$("#previewframe").contents().find(
						"#dialogPopup .dialogbuttons .button").css("color",
						newvalue);
				$("#previewframe").contents().find(".button").css("color",
						newvalue);
				$("#previewframe").contents().find(".editButton .label").css(
						"color", newvalue);
				$("#previewframe")
			...
			case "@button-success-background":
				$("#previewframe").contents().find(".savebutton").css(
						"background", newvalue);
				$("#previewframe").contents().find(
						".proceedButton .label, .saveButton .label").css(
						"background", newvalue);
				$("#previewframe").contents().find(".syncButton").css(
						"background-color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@button-success-label-color":
				$("#previewframe").contents().find(".savebutton").css("color",
						newvalue);
				$("#previewframe").contents().find(
						".proceedButton .label, .saveButton .label").css(
						"color", newvalue);
				$("#previewframe").contents().find(".syncButton").css("color",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@button-danger-background":
				$("#previewframe").contents().find(".cancelbutton").css(
						"background", newvalue);
				$("#previewframe").contents().find(".cancelButton .label").css(
						"background-color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@footer-border-top":
				$("#previewframe").contents().find(".footer").css("border-top",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@footer-background":
				$("#previewframe").contents().find(".footer").css("background",
						newvalue);
				break;
			...
			case "@footerTabtext-font-size":
				$("#previewframe").contents().find(
						"#footerTabBar li .footerTabtext").css("font-size",
						newvalue);
				break;
			case "@footerTabtext-font-weight":
				$("#previewframe").contents().find(
						"#footerTabBar li .footerTabtext").css("font-weight",
						newvalue);
				break;
			...
			case "@menuitems-border-radius":
				$("#previewframe").contents().find(".navScrollArea li:first")
						.css("-webkit-border-top-left-radius", newvalue);
				$("#previewframe").contents().find(".navScrollArea li:first")
						.css("-webkit-border-top-right-radius", newvalue);
				$("#previewframe").contents().find(".navScrollArea li:last")
						.css("-webkit-border-bottom-left-radius", newvalue);
				$("#previewframe").contents().find(".navScrollArea li:last")
						.css("-webkit-border-bottom-right-radius", newvalue);
				$("#previewframe").contents().find("#menuitems a:first").css(
						"-webkit-border-top-left-radius", newvalue);
				$("#previewframe").contents().find("#menuitems a:first").css(
						"-webkit-border-top-right-radius", newvalue);
			...
			case "@menuitems-border-outer":
				...
				$("#previewframe").contents().find(".navScrollArea li:first")
						.css("border-top", newvalue);
				$("#previewframe").contents().find(".navScrollArea li:last")
						.css("border-bottom", newvalue);
				$("#previewframe").contents().find("#menuitems li").css(
						"border-left", newvalue);
				$("#previewframe").contents().find("#menuitems li").css(
						"border-right", newvalue);
				$("#previewframe").contents().find("#menuitems li:first").css(
						"border-top", newvalue);
			...
			case "@menuitems-color":
				$("#previewframe").contents().find(".navScrollArea li").css(
						"color", newvalue);
				$("#previewframe").contents().find(
						".navScrollArea li .menulink").css("color", newvalue);
				$("#previewframe").contents().find("#menuitems li").css(
						"color", newvalue);
				$("#previewframe").contents().find("#menuitems li a").css(
						"color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@menuitems-text-shadow":
				$("#previewframe").contents().find(".navScrollArea li").css(
						"text-shadow", newvalue);
				$("#previewframe").contents().find(
						".navScrollArea li .menulink").css("text-shadow",
						newvalue);
				$("#previewframe").contents().find("#menuitems li").css(
						"text-shadow", newvalue);
				$("#previewframe").contents().find("#menuitems li a").css(
			...
			case "@menuitems-selected-color":
				$("#previewframe").contents().find(
						".navScrollArea li.viewMenuItemSelected").css("color",
						newvalue);
				$("#previewframe").contents().find(
						".navScrollArea li.viewMenuItemSelected .menulink")
						.css("color", newvalue);
				$("#previewframe").contents().find(
						".navScrollArea li.viewMenuItemSelected i").css(
						"color", newvalue);
				$("#previewframe").contents().find("#menuitems a.active").css(
						"color", newvalue);
				$("#previewframe").contents().find("#menuitems a.active i")
						.css("color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@menuitems-selected-background":
				$("#previewframe").contents().find(
						".navScrollArea li.viewMenuItemSelected").css(
						"background", newvalue);
				$("#previewframe").contents().find("#menuitems .active").css(
						"background", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@menuitems-sub-background":
				$("#previewframe").contents().find(
						".navScrollArea li.viewMenuItemSub").css("background",
						newvalue);
				$("#previewframe").contents().find(
						"#menuitems .viewMenuItemSub").css("background",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@menuitems-sub-border":
				$("#previewframe").contents().find(
						".navScrollArea li.viewMenuItemSub").css(
						"border-color", newvalue);
				$("#previewframe").contents().find(
						"#menuitems .viewMenuItemSub").css("border-color",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@menuitems-subsub-background":
				$("#previewframe").contents().find(
						".navScrollArea li.viewMenuItemSubSub").css(
						"background", newvalue);
				$("#previewframe").contents().find(
						"#menuitems .viewMenuItemSubSub").css("background",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@menuitems-subsub-border":
				$("#previewframe").contents().find(
						...
						"border-color", newvalue);
				$("#previewframe").contents().find(
						"#menuitems .viewMenuItemSubSub").css("border-color",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@content-padding":
				$("#previewframe").contents().find(".panel, fieldset").css(
						"margin", newvalue);
				$("#previewframe").contents().find(".bordered").css("padding",
						newvalue);
				$("#previewframe").contents().find("#formholder").css("margin",
						newvalue);
				break;
			case "@content-border-radius":
				$("#previewframe").contents().find(
						".panel, fieldset, legend, #dialogPopup, #summaryList")
						.css("border-radius", newvalue);
				$("#previewframe").contents().find(".bordered li:first").css(
						"-webkit-border-top-left-radius", newvalue);
				$("#previewframe").contents().find(".bordered li:first").css(
						"-webkit-border-top-right-radius", newvalue);
				$("#previewframe").contents().find(".bordered li:last").css(
						"-webkit-border-bottom-left-radius", newvalue);
				$("#previewframe").contents().find(".bordered li:last").css(
						"-webkit-border-bottom-right-radius", newvalue);
				$("#previewframe").contents().find(".categoryRow:first").css(
						"border-top-left-radius", newvalue);
				$("#previewframe").contents().find(".categoryRow:first").css(
						"border-top-right-radius", newvalue);
				$("#previewframe").contents().find(".categoryRow:last").css(
						"border-bottom-left-radius", newvalue);
				$("#previewframe").contents().find(".categoryRow:last").css(
						"border-bottom-right-radius", newvalue);
				$("#previewframe").contents().find("#formholder").css(
						"-webkit-border-radius", newvalue);
				$("#previewframe").contents().find("#formholder h2").css(
						"-webkit-border-top-left-radius", newvalue);
				$("#previewframe").contents().find("#formholder h2").css(
						"-webkit-border-top-right-radius", newvalue);
				$("#previewframe").contents().find("#formholder ul.buttons")
						.css("-webkit-border-bottom-left-radius", newvalue);
				$("#previewframe").contents().find("#formholder ul.buttons")
						.css("-webkit-border-bottom-right-radius", newvalue);
				$("#previewframe").contents().find("#formholder ul.fieldlist")
						.css("-webkit-border-bottom-left-radius", newvalue);
				$("#previewframe").contents().find("#formholder ul.fieldlist")
						.css("-webkit-border-bottom-right-radius", newvalue);
				break;
			case "@content-heading-color":
				$("#previewframe").contents().find(".panel h1, fieldset h1")
						.css("color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@content-subheading-color":
				$("#previewframe")
						.contents()
						.find(
								".panel h2, fieldset h2, .panel h2.xspTextComputedField, fieldset h2.xspTextComputedField")
						.css("color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@table-heading-color":
				$("#previewframe").contents().find(
						...
						"color", newvalue);
				$("#previewframe").contents().find("#summaryList.categoryRow")
						.css("border-left-color", newvalue);
				$("#previewframe").contents().find(
						"#summaryList.categoryRow.accordionExpanded").css(
						"border-top-color", newvalue);
			...
			case "@table-heading-background":
				$("#previewframe").contents().find(
						"li.title, li#title, .categoryRow").css("background",
						newvalue);
				$("#previewframe").contents().find("#formholder h2").css(
						"background", newvalue);
				thefield.next().css("background-color", newvalue);
			...
			case "@table-heading-text-shadow":
				...
				$("#previewframe").contents().find("#formholder h2 span").css(
						"text-shadow", newvalue);
				$("#previewframe").contents().find(".categoryRowFixed span")
						.css("text-shadow", newvalue);
				break;
			case "@table-heading-box-shadow":
				$("#previewframe").contents().find(
						"li.title, li#title, .categoryRow").css("box-shadow",
						newvalue);
				$("#previewframe").contents().find("#formholder h2 span").css(
						"box-shadow", newvalue);
				break;
			case "@table-subheading-border-color":
				$("#previewframe").contents().find(".categoryRowFixed").css(
						"border-bottom-color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@table-row-border-color":
				$("#previewframe").contents().find("li.data-row").css(
						"border-color", newvalue);
				$("#previewframe").contents().find(
						"#formholder .editmode label").css("border-color",
						newvalue);
				$("#previewframe").contents().find(
						"#formholder label.widelabel").css("border-color",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@table-row-title-font-color":
				$("#previewframe").contents().find("li.data-row").css("color",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@table-row-img-border-radius":
				$("#previewframe").contents().find("li.data-row.rowphoto").css(
						"-webkit-border-radius", newvalue);
				break;
			case "@table-row-detail-font-color":
				$("#previewframe").contents()
						.find("li.data-row.viewlistdetail").css("color",
								newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@table-row-detail-font-size":
				$("#previewframe").contents()
						.find("li.data-row.viewlistdetail").css("font-size",
								newvalue);
				break;
			case "@table-row-detail-font-weight":
				$("#previewframe").contents()
						.find("li.data-row.viewlistdetail").css("font-weight",
								newvalue);
				break;
			case "@form-label-color":
				$("#previewframe").contents().find("#formholder label").css(
						"color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@form-label-background":
				$("#previewframe").contents().find(
						"#formholder .editmode label").css("background",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@form-input-color":
				$("#previewframe")
						.contents()
						.find(
								"#formholder .xspInputFieldEditBox, #formholder .xspListBox, #formholder textarea, .deleteicon span")
						.css("color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@form-input-font-weight":
				$("#previewframe")
						.contents()
						.find(
								"#formholder .xspInputFieldEditBox, #formholder .xspListBox, #formholder textarea")
						.css("font-weight", newvalue);
				break;
			...
			case "@workspace-item-text-color":
				$("#previewframe").contents().find(".workspace-items span")
						.css("color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@swiper-scroll-container-background-color":
				$("#previewframe").contents().find("swiper-scroll-container")
						.css("background-color", newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			case "@hviewtitle-color":
				$("#previewframe").contents().find(".hviewtitle").css("color",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
			...
			case "@h1-hview-h1-color":
				$("#previewframe").contents().find("h1.hview-h1").css("color",
						newvalue);
				thefield.next().css("background-color", newvalue);
				break;
...
function incrementProgress() {
	...
	console.log("width changing from " + oldwidth + " to " + newwidth);
	$(".progress-bar").width((oldwidth + 1) + "%");
	oldwidth = newwidth;
	if (newwidth < 100) {
		setTimeout(incrementProgress, 333);
	}
